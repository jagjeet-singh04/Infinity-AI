...
export default function App() {
  ...
  async function handleOpenInChatGPTWeb() {
  ...
  async function handleOpenInChatGPTApp() {
    const copied = await copyTextToClipboard();
    if (copied) {
      // Try to open the app with a timeout fallback
      window.location.href = "chatgpt://";
      
      // If the app isn't installed, this will fail and we can redirect to web after a delay
      setTimeout(() => {
        window.open("https://chat.openai.com", "_blank", "noopener,noreferrer");
      }, 500);
    }
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow p-5">
        ...
        <div className="mt-4">
          <TextResult
            ...
            onOpenChatWeb={handleOpenInChatGPTWeb}  // Changed prop name
